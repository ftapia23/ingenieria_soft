...
%	\begin{tabular}{p{5cm}|p{11cm}}
		...
		\hline\hline
			{{\color{blue}\textbf{RP1}}} & {Los cursos no pueden ser publicados sin antes ser aprobamos por los coordinadores.}\\ %en lugar de los puntos suspensivos debe ir la descripción de la regla
			\hline
